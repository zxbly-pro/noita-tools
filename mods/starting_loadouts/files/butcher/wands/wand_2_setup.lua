...
local wand = { }
wand.name = {"butcher_wand"}
wand.deck_capacity = {3,4}
wand.actions_per_round = 1
wand.reload_time = {20,50}
wand.shuffle_deck_when_empty = 0
wand.fire_rate_wait = {20,45}
wand.spread_degrees = {2,5}
wand.speed_multiplier = 1
wand.mana_charge_speed = {15,35}
wand.mana_max = {110,140}
wand.actions = { "DISC_BULLET", "DISC_BULLET_BIG", "DISC_BULLET" }
...
ComponentObjectSetValue( ability_comp, "gunaction_config", "speed_multiplier", speed )
