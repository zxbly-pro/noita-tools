...
const PanelsSettings = () => {
  return (
    <>
      <ConfigTitle title="面板" subtitle="选择要显示的信息面板。" />
      <ListGroup variant="flush" className="mb-5 shadow">
        <ListGroup.Item>
          <PanelToggle key="alchemy" id="alchemy" title="炼金术" />
        </ListGroup.Item>
        <ListGroup.Item>
          <PanelToggle key="biome" id="biome" title="生态" />
        </ListGroup.Item>
        <ListGroup.Item>
          <PanelToggle key="fungal" id="fungal" title="真菌转换" />
        </ListGroup.Item>
        <ListGroup.Item>
        ...
        <ListGroup.Item>
          <PanelToggle key="start" id="start" title="初始配置" />
        </ListGroup.Item>
        <ListGroup.Item>
          <PanelToggle key="watercave" id="watercave" title="水洞" />
        </ListGroup.Item>
        <ListGroup.Item>
          <PanelToggle key="secret-wands" id="secret-wands" title="隐藏法杖" />
        </ListGroup.Item>
        {/* <ListGroup.Item>
