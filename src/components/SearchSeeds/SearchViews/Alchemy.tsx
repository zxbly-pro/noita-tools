    ...
    <Row className="pb-3">
      <Col {...ColProps}>
        <Row className="justify-content-center pb-2">
          <Row>
            <Col>
              <p {...(!enoughAlchemy ? { className: "text-danger" } : {})}>不选或至少选择一(1)种：</p>
            </Col>
          </Row>
          <Row>
            <Col>
      ...
      <Col {...ColProps}>
        <Row className="justify-content-center pb-2">
          <Row>
            <Col>
              <p {...(!enoughLiquids ? { className: "text-danger" } : {})}>不选或至少选择两(2)种：</p>
            </Col>
          </Row>
          <Row>
            <Col>
  ...
  return (
    <Container>
      <Row>
        <p>
          列表留空表示接受任意组合。<br />
          搜索结果种子的活力药剂(LC)和炼金前体(AP)成分将从所选值中产生。<br />
          请注意，某些组合可能不存在或无实际用途。
        </p>
      </Row>
      <Row>
        <Col>
          <Row className="ms-2 me-2 ps-2  rounded shadow-sm">活力药剂(LC)：</Row>
        ...
        <Col>
          <Row className="ms-2 me-2 ps-2  rounded shadow-sm">炼金前体(AP)：</Row>
          <RecipeIngredientsPicker
